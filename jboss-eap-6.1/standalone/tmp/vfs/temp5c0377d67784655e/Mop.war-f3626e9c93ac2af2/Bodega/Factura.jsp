    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <br>
                    <form action="Controlador?menu=ingreso&accion=lista" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <form action="Controlador?menu=ingreso&accion=agregar" method="POST" enctype="multipart/form-data">
