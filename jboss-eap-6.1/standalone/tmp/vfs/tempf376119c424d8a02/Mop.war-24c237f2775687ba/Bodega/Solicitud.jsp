            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <label>Usuario</label>
                            <input class="form-control" id="txtusuario" name="txtusuario" value="${usuario.getNombre_usuario()}" disabled>
                            <label>Nombre</label>
                            <input class="form-control" id="txtnombre" name="txtnombre" value="${usuario.getNombre()}" disabled>
                            <label>Apellido</label>
                            <input class="form-control" id="txtapellido" name="txtapellido" value="${usuario.getApellido()}" disabled>
                            <label>Run</label>
                            <input class="form-control" id="txtrun" name="txtrun" value="${usuario.getRut()}" disabled>
                        </div>
                    </div>
                </div>
            </div>
